...
class TestImage(unittest.TestCase):
    def test_small(self):
        self.image_testnew('sunset_small.png')
    ...
    def image_testnew(self, filename):
        image = Image.open("sunset_small.png")
        imageResized = ResizeableImage(image.resize((1000,1000)))
        seam = imageResized.best_seam()

        self.assertEqual(imageResized.height, len(seam), 'Seam wrong size.')
